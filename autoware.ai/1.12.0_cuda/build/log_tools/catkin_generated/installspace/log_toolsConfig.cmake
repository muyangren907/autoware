...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'log_tools' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/muyangren907/autoware/autoware.ai/1.12.0_cuda/install/log_tools/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/muyangren907/autoware/autoware.ai/1.12.0_cuda/install/log_tools/lib;/home/muyangren907/autoware/autoware.ai/1.12.0_cuda/install/autoware_build_flags/lib;/opt/ros/melodic/lib)
