...
"""autogenerated by genpy from autoware_system_msgs/HardwareStatus.msg. Do not edit."""
import sys
...
class HardwareStatus(genpy.Message):
  _md5sum = "9eabc3d8c7987df06c9b8453332071a9"
  _type = "autoware_system_msgs/HardwareStatus"
...
uint8 ERROR = 3
uint8 FATAL = 4"""
  __slots__ = ['header','hardware_name','status']
  _slot_types = ['std_msgs/Header','string','autoware_system_msgs/DiagnosticStatusArray[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.hardware_name = str[start:end].decode('utf-8')
      else:
