...
if("TRUE" STREQUAL "TRUE")
  set(rosbag_controller_SOURCE_PREFIX /home/muyangren907/autoware/autoware.ai/1.12.0_cuda/src/autoware/utilities/rosbag_controller)
  set(rosbag_controller_DEVEL_PREFIX /home/muyangren907/autoware/autoware.ai/1.12.0_cuda/build/rosbag_controller/devel)
  ...
  set(rosbag_controller_INSTALL_PREFIX /home/muyangren907/autoware/autoware.ai/1.12.0_cuda/install/rosbag_controller)
...
if(NOT "/usr/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosbag_controller' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/muyangren907/autoware/autoware.ai/1.12.0_cuda/src/autoware/utilities/rosbag_controller/${idir}'.  ${_report}")
    endif()
    _list_append_unique(rosbag_controller_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "rosbag_controller;/usr/lib/x86_64-linux-gnu/libboost_date_time.so;/usr/lib/x86_64-linux-gnu/libboost_regex.so;/usr/lib/x86_64-linux-gnu/libboost_program_options.so;/usr/lib/x86_64-linux-gnu/libboost_filesystem.so;/usr/lib/x86_64-linux-gnu/libboost_thread.so;/usr/lib/x86_64-linux-gnu/libboost_system.so;/usr/lib/x86_64-linux-gnu/libboost_chrono.so;/usr/lib/x86_64-linux-gnu/libboost_atomic.so")
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/muyangren907/autoware/autoware.ai/1.12.0_cuda/build/rosbag_controller/devel/lib;/opt/ros/melodic/lib)
