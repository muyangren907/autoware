// Generated by gencpp from file sick_ldmrs_msgs/Object.msg
// DO NOT EDIT!


#ifndef SICK_LDMRS_MSGS_MESSAGE_OBJECT_H
#define SICK_LDMRS_MSGS_MESSAGE_OBJECT_H
...
struct Object_
{
  ...
  typedef boost::shared_ptr< ::sick_ldmrs_msgs::Object_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::sick_ldmrs_msgs::Object_<ContainerAllocator> const> ConstPtr;

}; // struct Object_

typedef ::sick_ldmrs_msgs::Object_<std::allocator<void> > Object;

typedef boost::shared_ptr< ::sick_ldmrs_msgs::Object > ObjectPtr;
typedef boost::shared_ptr< ::sick_ldmrs_msgs::Object const> ObjectConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::sick_ldmrs_msgs::Object_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::sick_ldmrs_msgs::Object_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
// {'geometry_msgs': ['/opt/ros/melodic/share/geometry_msgs/cmake/../msg'], 'sick_ldmrs_msgs': ['/home/muyangren907/autoware/autoware.ai/1.12.0_cuda/src/drivers/awf_drivers/sick_ldmrs_msgs/msg'], 'std_msgs': ['/opt/ros/melodic/share/std_msgs/cmake/../msg']}
...
template <class ContainerAllocator>
struct IsFixedSize< ::sick_ldmrs_msgs::Object_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::sick_ldmrs_msgs::Object_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::sick_ldmrs_msgs::Object_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::sick_ldmrs_msgs::Object_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::sick_ldmrs_msgs::Object_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::sick_ldmrs_msgs::Object_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::sick_ldmrs_msgs::Object_<ContainerAllocator> >
{
  ...
  static const char* value(const ::sick_ldmrs_msgs::Object_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xa5d0f2d250163ffaULL;
  static const uint64_t static_value2 = 0x0098d0fc8218fc4aULL;
};

template<class ContainerAllocator>
struct DataType< ::sick_ldmrs_msgs::Object_<ContainerAllocator> >
{
  static const char* value()
  {
    return "sick_ldmrs_msgs/Object";
  }
...
template<class ContainerAllocator>
struct Definition< ::sick_ldmrs_msgs::Object_<ContainerAllocator> >
{
  static const char* value()
  {
    return "int32 id\n"
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::sick_ldmrs_msgs::Object_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::sick_ldmrs_msgs::Object_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::sick_ldmrs_msgs::Object_<ContainerAllocator>& v)
  {
    s << indent << "id: ";
...
#endif // SICK_LDMRS_MSGS_MESSAGE_OBJECT_H
