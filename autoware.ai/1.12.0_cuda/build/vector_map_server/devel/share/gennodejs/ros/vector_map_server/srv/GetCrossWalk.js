...
class GetCrossWalkRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type GetCrossWalkRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type GetCrossWalkRequest
    let len;
    let data = new GetCrossWalkRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new GetCrossWalkRequest(null);
...
class GetCrossWalkResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('objects')) {
        ...
        this.objects = new vector_map_msgs.msg.CrossWalkArray();
      }
    }
  }

  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type GetCrossWalkResponse
    // Serialize message field [objects]
    bufferOffset = vector_map_msgs.msg.CrossWalkArray.serialize(obj.objects, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type GetCrossWalkResponse
    let len;
    let data = new GetCrossWalkResponse(null);
    // Deserialize message field [objects]
    data.objects = vector_map_msgs.msg.CrossWalkArray.deserialize(buffer, bufferOffset);
    return data;
  }

  static getMessageSize(object) {
    let length = 0;
    length += vector_map_msgs.msg.CrossWalkArray.getMessageSize(object.objects);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new GetCrossWalkResponse(null);
    if (msg.objects !== undefined) {
      resolved.objects = vector_map_msgs.msg.CrossWalkArray.Resolve(msg.objects)
    }
    else {
      resolved.objects = new vector_map_msgs.msg.CrossWalkArray()
    }
...
module.exports = {
  Request: GetCrossWalkRequest,
  Response: GetCrossWalkResponse,
  md5sum() { return '5eaa88405db0c4e45d229b723f6f1eb2'; },
  datatype() { return 'vector_map_server/GetCrossWalk'; }
};
