...
class GetCrossRoadRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type GetCrossRoadRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type GetCrossRoadRequest
    let len;
    let data = new GetCrossRoadRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new GetCrossRoadRequest(null);
...
class GetCrossRoadResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('objects')) {
        ...
        this.objects = new vector_map_msgs.msg.CrossRoadArray();
      }
    }
  }

  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type GetCrossRoadResponse
    // Serialize message field [objects]
    bufferOffset = vector_map_msgs.msg.CrossRoadArray.serialize(obj.objects, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type GetCrossRoadResponse
    let len;
    let data = new GetCrossRoadResponse(null);
    // Deserialize message field [objects]
    data.objects = vector_map_msgs.msg.CrossRoadArray.deserialize(buffer, bufferOffset);
    return data;
  }

  static getMessageSize(object) {
    let length = 0;
    length += vector_map_msgs.msg.CrossRoadArray.getMessageSize(object.objects);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new GetCrossRoadResponse(null);
    if (msg.objects !== undefined) {
      resolved.objects = vector_map_msgs.msg.CrossRoadArray.Resolve(msg.objects)
    }
    else {
      resolved.objects = new vector_map_msgs.msg.CrossRoadArray()
    }
...
module.exports = {
  Request: GetCrossRoadRequest,
  Response: GetCrossRoadResponse,
  md5sum() { return '960088d98f027e8a008897cb0578f71b'; },
  datatype() { return 'vector_map_server/GetCrossRoad'; }
};
