...
class GetWhiteLineRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type GetWhiteLineRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type GetWhiteLineRequest
    let len;
    let data = new GetWhiteLineRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new GetWhiteLineRequest(null);
...
class GetWhiteLineResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('objects')) {
        ...
        this.objects = new vector_map_msgs.msg.WhiteLineArray();
      }
    }
  }

  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type GetWhiteLineResponse
    // Serialize message field [objects]
    bufferOffset = vector_map_msgs.msg.WhiteLineArray.serialize(obj.objects, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type GetWhiteLineResponse
    let len;
    let data = new GetWhiteLineResponse(null);
    // Deserialize message field [objects]
    data.objects = vector_map_msgs.msg.WhiteLineArray.deserialize(buffer, bufferOffset);
    return data;
  }

  static getMessageSize(object) {
    let length = 0;
    length += vector_map_msgs.msg.WhiteLineArray.getMessageSize(object.objects);
    return length;
  }
  ...
  static messageDefinition() {
    // Returns full string definition for message
    return `
    vector_map_msgs/WhiteLineArray objects
  ...
  static Resolve(msg) {
    ...
    const resolved = new GetWhiteLineResponse(null);
    if (msg.objects !== undefined) {
      resolved.objects = vector_map_msgs.msg.WhiteLineArray.Resolve(msg.objects)
    }
    else {
      resolved.objects = new vector_map_msgs.msg.WhiteLineArray()
    }
...
module.exports = {
  Request: GetWhiteLineRequest,
  Response: GetWhiteLineResponse,
  md5sum() { return 'b9ad0628dfd0c354e7f8a65e05fb7bcc'; },
  datatype() { return 'vector_map_server/GetWhiteLine'; }
};
