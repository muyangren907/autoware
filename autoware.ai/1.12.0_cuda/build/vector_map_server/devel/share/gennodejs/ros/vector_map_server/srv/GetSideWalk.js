...
class GetSideWalkRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type GetSideWalkRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type GetSideWalkRequest
    let len;
    let data = new GetSideWalkRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new GetSideWalkRequest(null);
...
class GetSideWalkResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('objects')) {
        ...
        this.objects = new vector_map_msgs.msg.SideWalkArray();
      }
    }
  }

  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type GetSideWalkResponse
    // Serialize message field [objects]
    bufferOffset = vector_map_msgs.msg.SideWalkArray.serialize(obj.objects, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type GetSideWalkResponse
    let len;
    let data = new GetSideWalkResponse(null);
    // Deserialize message field [objects]
    data.objects = vector_map_msgs.msg.SideWalkArray.deserialize(buffer, bufferOffset);
    return data;
  }

  static getMessageSize(object) {
    let length = 0;
    length += vector_map_msgs.msg.SideWalkArray.getMessageSize(object.objects);
    return length;
  }
  ...
  static messageDefinition() {
    // Returns full string definition for message
    return `
    vector_map_msgs/SideWalkArray objects
  ...
  static Resolve(msg) {
    ...
    const resolved = new GetSideWalkResponse(null);
    if (msg.objects !== undefined) {
      resolved.objects = vector_map_msgs.msg.SideWalkArray.Resolve(msg.objects)
    }
    else {
      resolved.objects = new vector_map_msgs.msg.SideWalkArray()
    }
...
module.exports = {
  Request: GetSideWalkRequest,
  Response: GetSideWalkResponse,
  md5sum() { return '960088d98f027e8a008897cb0578f71b'; },
  datatype() { return 'vector_map_server/GetSideWalk'; }
};
