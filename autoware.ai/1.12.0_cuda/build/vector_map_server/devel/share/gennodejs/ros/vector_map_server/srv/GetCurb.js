...
class GetCurbRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type GetCurbRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type GetCurbRequest
    let len;
    let data = new GetCurbRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new GetCurbRequest(null);
...
class GetCurbResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('objects')) {
        ...
        this.objects = new vector_map_msgs.msg.CurbArray();
      }
    }
  }

  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type GetCurbResponse
    // Serialize message field [objects]
    bufferOffset = vector_map_msgs.msg.CurbArray.serialize(obj.objects, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type GetCurbResponse
    let len;
    let data = new GetCurbResponse(null);
    // Deserialize message field [objects]
    data.objects = vector_map_msgs.msg.CurbArray.deserialize(buffer, bufferOffset);
    return data;
  }

  static getMessageSize(object) {
    let length = 0;
    length += vector_map_msgs.msg.CurbArray.getMessageSize(object.objects);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new GetCurbResponse(null);
    if (msg.objects !== undefined) {
      resolved.objects = vector_map_msgs.msg.CurbArray.Resolve(msg.objects)
    }
    else {
      resolved.objects = new vector_map_msgs.msg.CurbArray()
    }
...
module.exports = {
  Request: GetCurbRequest,
  Response: GetCurbResponse,
  md5sum() { return '28da9385b8b41ad0a9d9d7399a4ae4e2'; },
  datatype() { return 'vector_map_server/GetCurb'; }
};
