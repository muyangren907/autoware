...
export GAZEBO_RESOURCE_PATH=/home/muyangren907/autoware/autoware.ai/1.12.0_cuda/install/citysim/share/citysim-0/:$GAZEBO_RESOURCE_PATH

# add path to gazebo models from citysim_resources
export GAZEBO_MODEL_PATH=/home/muyangren907/autoware/autoware.ai/1.12.0_cuda/install/citysim/share/citysim-0/models:$GAZEBO_MODEL_PATH

# Add the directories containing our Gazebo plugins to GAZEBO_PLUGIN_PATH.
export GAZEBO_PLUGIN_PATH=/home/muyangren907/autoware/autoware.ai/1.12.0_cuda/install/citysim/lib/citysim-0/plugins:$GAZEBO_PLUGIN_PATH
