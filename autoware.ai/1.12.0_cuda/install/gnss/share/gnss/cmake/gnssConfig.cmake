...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'gnss' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/muyangren907/autoware/autoware.ai/1.12.0_cuda/install/gnss/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/muyangren907/autoware/autoware.ai/1.12.0_cuda/install/gnss/lib;/opt/ros/melodic/lib)
