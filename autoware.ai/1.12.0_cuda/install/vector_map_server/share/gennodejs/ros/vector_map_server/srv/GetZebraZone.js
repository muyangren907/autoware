...
class GetZebraZoneRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type GetZebraZoneRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type GetZebraZoneRequest
    let len;
    let data = new GetZebraZoneRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new GetZebraZoneRequest(null);
...
class GetZebraZoneResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('objects')) {
        ...
        this.objects = new vector_map_msgs.msg.ZebraZoneArray();
      }
    }
  }

  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type GetZebraZoneResponse
    // Serialize message field [objects]
    bufferOffset = vector_map_msgs.msg.ZebraZoneArray.serialize(obj.objects, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type GetZebraZoneResponse
    let len;
    let data = new GetZebraZoneResponse(null);
    // Deserialize message field [objects]
    data.objects = vector_map_msgs.msg.ZebraZoneArray.deserialize(buffer, bufferOffset);
    return data;
  }

  static getMessageSize(object) {
    let length = 0;
    length += vector_map_msgs.msg.ZebraZoneArray.getMessageSize(object.objects);
    return length;
  }
  ...
  static messageDefinition() {
    // Returns full string definition for message
    return `
    vector_map_msgs/ZebraZoneArray objects
  ...
  static Resolve(msg) {
    ...
    const resolved = new GetZebraZoneResponse(null);
    if (msg.objects !== undefined) {
      resolved.objects = vector_map_msgs.msg.ZebraZoneArray.Resolve(msg.objects)
    }
    else {
      resolved.objects = new vector_map_msgs.msg.ZebraZoneArray()
    }
...
module.exports = {
  Request: GetZebraZoneRequest,
  Response: GetZebraZoneResponse,
  md5sum() { return '960088d98f027e8a008897cb0578f71b'; },
  datatype() { return 'vector_map_server/GetZebraZone'; }
};
