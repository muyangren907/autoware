...
class GetRoadMarkRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type GetRoadMarkRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type GetRoadMarkRequest
    let len;
    let data = new GetRoadMarkRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new GetRoadMarkRequest(null);
...
class GetRoadMarkResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('objects')) {
        ...
        this.objects = new vector_map_msgs.msg.RoadMarkArray();
      }
    }
  }

  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type GetRoadMarkResponse
    // Serialize message field [objects]
    bufferOffset = vector_map_msgs.msg.RoadMarkArray.serialize(obj.objects, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type GetRoadMarkResponse
    let len;
    let data = new GetRoadMarkResponse(null);
    // Deserialize message field [objects]
    data.objects = vector_map_msgs.msg.RoadMarkArray.deserialize(buffer, bufferOffset);
    return data;
  }

  static getMessageSize(object) {
    let length = 0;
    length += vector_map_msgs.msg.RoadMarkArray.getMessageSize(object.objects);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new GetRoadMarkResponse(null);
    if (msg.objects !== undefined) {
      resolved.objects = vector_map_msgs.msg.RoadMarkArray.Resolve(msg.objects)
    }
    else {
      resolved.objects = new vector_map_msgs.msg.RoadMarkArray()
    }
...
module.exports = {
  Request: GetRoadMarkRequest,
  Response: GetRoadMarkResponse,
  md5sum() { return 'ad9b450340842efc70293ff26210d059'; },
  datatype() { return 'vector_map_server/GetRoadMark'; }
};
