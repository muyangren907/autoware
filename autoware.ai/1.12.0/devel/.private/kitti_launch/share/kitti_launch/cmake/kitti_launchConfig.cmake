...
if("TRUE" STREQUAL "TRUE")
  set(kitti_launch_SOURCE_PREFIX /home/myr907/autoware.ai/src/autoware/utilities/kitti_launch)
  set(kitti_launch_DEVEL_PREFIX /home/myr907/autoware.ai/devel/.private/kitti_launch)
  ...
  set(kitti_launch_INSTALL_PREFIX /home/myr907/autoware.ai/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'kitti_launch' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/myr907/autoware.ai/src/autoware/utilities/kitti_launch/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/myr907/autoware.ai/devel/.private/kitti_launch/lib;/home/myr907/autoware.ai/devel/lib;/opt/ros/melodic/lib)
