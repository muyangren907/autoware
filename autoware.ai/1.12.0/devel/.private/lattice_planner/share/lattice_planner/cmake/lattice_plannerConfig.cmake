...
if("TRUE" STREQUAL "TRUE")
  set(lattice_planner_SOURCE_PREFIX /home/myr907/autoware.ai/src/autoware/core_planning/lattice_planner)
  set(lattice_planner_DEVEL_PREFIX /home/myr907/autoware.ai/devel/.private/lattice_planner)
  ...
  set(lattice_planner_INSTALL_PREFIX /home/myr907/autoware.ai/install)
...
if(NOT "/home/myr907/autoware.ai/src/autoware/core_planning/lattice_planner/include " STREQUAL " ")
  set(lattice_planner_INCLUDE_DIRS "")
  set(_include_dirs "/home/myr907/autoware.ai/src/autoware/core_planning/lattice_planner/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'lattice_planner' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/myr907/autoware.ai/src/autoware/core_planning/lattice_planner/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/myr907/autoware.ai/devel/.private/lattice_planner/lib;/home/myr907/autoware.ai/devel/lib;/opt/ros/melodic/lib)
