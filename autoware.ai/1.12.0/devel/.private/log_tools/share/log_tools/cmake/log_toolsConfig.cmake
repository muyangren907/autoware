...
if("TRUE" STREQUAL "TRUE")
  set(log_tools_SOURCE_PREFIX /home/myr907/autoware.ai/src/autoware/utilities/log_tools)
  set(log_tools_DEVEL_PREFIX /home/myr907/autoware.ai/devel/.private/log_tools)
  ...
  set(log_tools_INSTALL_PREFIX /home/myr907/autoware.ai/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'log_tools' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/myr907/autoware.ai/src/autoware/utilities/log_tools/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/myr907/autoware.ai/devel/.private/log_tools/lib;/home/myr907/autoware.ai/devel/lib;/opt/ros/melodic/lib)
