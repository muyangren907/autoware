...
if("TRUE" STREQUAL "TRUE")
  set(naive_motion_predict_SOURCE_PREFIX /home/myr907/autoware.ai/src/autoware/core_perception/naive_motion_predict)
  set(naive_motion_predict_DEVEL_PREFIX /home/myr907/autoware.ai/devel/.private/naive_motion_predict)
  ...
  set(naive_motion_predict_INSTALL_PREFIX /home/myr907/autoware.ai/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'naive_motion_predict' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/myr907/autoware.ai/src/autoware/core_perception/naive_motion_predict/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/myr907/autoware.ai/devel/.private/naive_motion_predict/lib;/home/myr907/autoware.ai/devel/lib;/opt/ros/melodic/lib)
