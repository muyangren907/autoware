...
if("TRUE" STREQUAL "TRUE")
  set(vehicle_socket_SOURCE_PREFIX /home/myr907/autoware.ai/src/autoware/utilities/vehicle_socket)
  set(vehicle_socket_DEVEL_PREFIX /home/myr907/autoware.ai/devel/.private/vehicle_socket)
  ...
  set(vehicle_socket_INSTALL_PREFIX /home/myr907/autoware.ai/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'vehicle_socket' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/myr907/autoware.ai/src/autoware/utilities/vehicle_socket/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/myr907/autoware.ai/devel/.private/vehicle_socket/lib;/home/myr907/autoware.ai/devel/lib;/opt/ros/melodic/lib)
