...
if("TRUE" STREQUAL "TRUE")
  set(vlg22c_cam_SOURCE_PREFIX /home/myr907/autoware.ai/src/drivers/awf_drivers/baumer)
  set(vlg22c_cam_DEVEL_PREFIX /home/myr907/autoware.ai/devel/.private/vlg22c_cam)
  ...
  set(vlg22c_cam_INSTALL_PREFIX /home/myr907/autoware.ai/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'vlg22c_cam' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/myr907/autoware.ai/src/drivers/awf_drivers/baumer/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/myr907/autoware.ai/devel/.private/vlg22c_cam/lib;/home/myr907/autoware.ai/devel/lib;/opt/ros/melodic/lib)
