...
class GetNodeRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type GetNodeRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type GetNodeRequest
    let len;
    let data = new GetNodeRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new GetNodeRequest(null);
...
class GetNodeResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('objects')) {
        ...
        this.objects = new vector_map_msgs.msg.NodeArray();
      }
    }
  }

  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type GetNodeResponse
    // Serialize message field [objects]
    bufferOffset = vector_map_msgs.msg.NodeArray.serialize(obj.objects, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type GetNodeResponse
    let len;
    let data = new GetNodeResponse(null);
    // Deserialize message field [objects]
    data.objects = vector_map_msgs.msg.NodeArray.deserialize(buffer, bufferOffset);
    return data;
  }

  static getMessageSize(object) {
    let length = 0;
    length += vector_map_msgs.msg.NodeArray.getMessageSize(object.objects);
    return length;
  }
  ...
  static messageDefinition() {
    // Returns full string definition for message
    return `
    vector_map_msgs/NodeArray objects
  ...
  static Resolve(msg) {
    ...
    const resolved = new GetNodeResponse(null);
    if (msg.objects !== undefined) {
      resolved.objects = vector_map_msgs.msg.NodeArray.Resolve(msg.objects)
    }
    else {
      resolved.objects = new vector_map_msgs.msg.NodeArray()
    }
...
module.exports = {
  ...
  md5sum() { return '18128901a5e61bc54c635df3d3633f33'; },
  datatype() { return 'vector_map_server/GetNode'; }
};
