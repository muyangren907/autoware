...
class GetWallRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type GetWallRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type GetWallRequest
    let len;
    let data = new GetWallRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new GetWallRequest(null);
...
class GetWallResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('objects')) {
        ...
        this.objects = new vector_map_msgs.msg.WallArray();
      }
    }
  }

  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type GetWallResponse
    // Serialize message field [objects]
    bufferOffset = vector_map_msgs.msg.WallArray.serialize(obj.objects, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type GetWallResponse
    let len;
    let data = new GetWallResponse(null);
    // Deserialize message field [objects]
    data.objects = vector_map_msgs.msg.WallArray.deserialize(buffer, bufferOffset);
    return data;
  }

  static getMessageSize(object) {
    let length = 0;
    length += vector_map_msgs.msg.WallArray.getMessageSize(object.objects);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new GetWallResponse(null);
    if (msg.objects !== undefined) {
      resolved.objects = vector_map_msgs.msg.WallArray.Resolve(msg.objects)
    }
    else {
      resolved.objects = new vector_map_msgs.msg.WallArray()
    }
...
module.exports = {
  Request: GetWallRequest,
  Response: GetWallResponse,
  md5sum() { return '960088d98f027e8a008897cb0578f71b'; },
  datatype() { return 'vector_map_server/GetWall'; }
};
