...
if("TRUE" STREQUAL "TRUE")
  set(rosbag_controller_SOURCE_PREFIX /home/myr907/autoware.ai/src/autoware/utilities/rosbag_controller)
  set(rosbag_controller_DEVEL_PREFIX /home/myr907/autoware.ai/devel/.private/rosbag_controller)
  ...
  set(rosbag_controller_INSTALL_PREFIX /home/myr907/autoware.ai/install)
...
if(NOT "/usr/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosbag_controller' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/myr907/autoware.ai/src/autoware/utilities/rosbag_controller/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/myr907/autoware.ai/devel/.private/rosbag_controller/lib;/home/myr907/autoware.ai/devel/lib;/opt/ros/melodic/lib)
