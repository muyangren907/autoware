...
public:
    ...
    {
        LabelMakerGui->setWindowTitle(QApplication::translate("LabelMakerGui", "trafficlight_recognizer/Label_Maker", Q_NULLPTR));
        label->setText(QApplication::translate("LabelMakerGui", "Image ID: ", Q_NULLPTR));
        green_radio_button_->setText(QApplication::translate("LabelMakerGui", "GREEN", Q_NULLPTR));
        yellow_radio_button_->setText(QApplication::translate("LabelMakerGui", "YELLOW", Q_NULLPTR));
        red_radio_button_->setText(QApplication::translate("LabelMakerGui", "RED", Q_NULLPTR));
        unknown_radio_button_->setText(QApplication::translate("LabelMakerGui", "UNKNOWN", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        previous_push_button_->setToolTip(QApplication::translate("LabelMakerGui", "Save the selection and Go Previous image", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        previous_push_button_->setText(QApplication::translate("LabelMakerGui", "< Previous", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        next_push_button_->setToolTip(QApplication::translate("LabelMakerGui", "Save the selection and Go Next image", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        ...
        next_push_button_->setText(QApplication::translate("LabelMakerGui", "Next >", Q_NULLPTR));
        label_2->setText(QApplication::translate("LabelMakerGui", "<html><head/><body><p>[<span style=\" font-weight:600;\">Mouse Drag</span>]: Specify traffic light area,  [<span style=\" font-weight:600;\">Mouse Wheel</span>]: Zoom In / Out</p></body></html>", Q_NULLPTR));
        reset_push_button_->setText(QApplication::translate("LabelMakerGui", "Reset Selection", Q_NULLPTR));
    } // retranslateUi
