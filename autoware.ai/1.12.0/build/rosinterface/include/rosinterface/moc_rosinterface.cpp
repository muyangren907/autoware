...
#include "../../../../src/autoware/visualization/rosinterface/include/rosinterface/rosinterface.h"
...
const QMetaObject ROSInterfaceBase::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_ROSInterfaceBase.data,
      qt_meta_data_ROSInterfaceBase,  qt_static_metacall, nullptr, nullptr}
};
...
void ROSSubBase::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ROSSubBase::receiveMessageSignal)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (ROSSubBase::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ROSSubBase::startReceiveSignal)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (ROSSubBase::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ROSSubBase::stopReceiveSignal)) {
                *result = 2;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ROSSubBase::resetQueryIntervalSignal)) {
                *result = 3;
                return;
            }
        }
...
const QMetaObject ROSSubBase::staticMetaObject = {
    { &ROSInterfaceBase::staticMetaObject, qt_meta_stringdata_ROSSubBase.data,
      qt_meta_data_ROSSubBase,  qt_static_metacall, nullptr, nullptr}
};
...
const QMetaObject ROSTFPub::staticMetaObject = {
    { &ROSInterfaceBase::staticMetaObject, qt_meta_stringdata_ROSTFPub.data,
      qt_meta_data_ROSTFPub,  qt_static_metacall, nullptr, nullptr}
};
...
void ROSTFSub::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ROSTFSub::receiveTFSignal)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (ROSTFSub::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ROSTFSub::startReceiveSignal)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (ROSTFSub::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ROSTFSub::stopReceiveSignal)) {
                *result = 2;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ROSTFSub::resetQueryIntervalSignal)) {
                *result = 3;
                return;
            }
        }
...
const QMetaObject ROSTFSub::staticMetaObject = {
    { &ROSInterfaceBase::staticMetaObject, qt_meta_stringdata_ROSTFSub.data,
      qt_meta_data_ROSTFSub,  qt_static_metacall, nullptr, nullptr}
};
