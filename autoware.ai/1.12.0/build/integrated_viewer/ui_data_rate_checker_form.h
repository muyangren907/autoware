...
public:
    ...
    {
        data_rate_checker_form->setWindowTitle(QApplication::translate("data_rate_checker_form", "Form", Q_NULLPTR));
        topic_label_->setText(QApplication::translate("data_rate_checker_form", "Topic: ", Q_NULLPTR));
        topic_frequency_label_->setText(QApplication::translate("data_rate_checker_form", "Topic frequency:", Q_NULLPTR));
        status_icon_label_->setText(QApplication::translate("data_rate_checker_form", "Status:", Q_NULLPTR));
        status_text_->setText(QApplication::translate("data_rate_checker_form", "No topic selected", Q_NULLPTR));
        min_frequency_label_->setText(QApplication::translate("data_rate_checker_form", "Min. Hz: ", Q_NULLPTR));
#ifndef QT_NO_TOOLTIP
        min_frequency_spin_box_->setToolTip(QApplication::translate("data_rate_checker_form", "<html><head/><body><p>Minimum frequency</p></body></html>", Q_NULLPTR));
#endif // QT_NO_TOOLTIP
        status_icon_->setText(QApplication::translate("data_rate_checker_form", "\342\227\211", Q_NULLPTR));
    } // retranslateUi
